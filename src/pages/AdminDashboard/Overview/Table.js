  ...
  return (
    <div className=" container pb-20 mx-auto">
      <div className="capitalize">
        <div className="font-bold whitespace-nowrap mb-4">leader board</div>

        <div className="flex items-center justify-between">
          <div className="flex items-center">
            <div className="relative mr-4">
              {" "}
              <select className="appearance-none text-text-color bg-transparent font-semibold relative outline-none pr-6 text-xs sm:text-sm md:text-base">
          ...
          <p className="text-sm text-[#97B550]">View all</p>
        </div>
      </div>
            ...
            {[...Array(10)].map((e, i) => (
              <tr className="" key={i}>
                ...
                <td className="">
                  {" "}
                  <span
                    className="cursor-pointer text-[#97B550]"
