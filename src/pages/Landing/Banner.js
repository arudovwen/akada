...
function Banner() {
  return (
    <div className="relative min-h-[400px] md:min-h-min lg:min-h-[550px] mt-8 py-8 mb-10">
      <div className="px-6 sm:px-0 sm:w-[93%] grid grid-cols-2 md:grid-cols-3 h-full md:gap-x-4 lg:gap-x-40 items-center ml-auto">
        <div className="col-span-1  font-bold text-left py-10 h-full flex  items-center relative">
          <div className="z-20">
            <p className="text-primary text-3xl sm:text-4xl md:text-5xl lg:text-[64px] md:leading-[71px] lg:mb-4 transition tracking-in-expand-fwd delay-300 duration-500">
              Subscribe.
            </p>
            <p className="text-primary   text-3xl sm:text-4xl  md:text-5xl lg:text-[64px] md:leading-[71px]  lg:mb-4 transition tracking-in-expand-fwd">
              Select.
            </p>
            <p className="text-primary  text-3xl sm:text-4xl md:text-5xl lg:text-[64px]  md:leading-[71px] mb-8 transition tracking-in-expand-fwd">
              Sponsor.
            </p>
            <Link to="/register">
          ...
          <div className="sm:flex space-x-5">
            <div className="ml-auto md:ml-0 w-[100%] md:w-[63%] relative overflow-hidden">
              <img
                ...
                className="rounded-2xl  md:h-[395px] lg:h-[32rem] w-full lg:block transition hover:kenburns-top"
              />
            </div>

            <div className=" md:w-[37%] lg:w-[25%] relative overflow-hidden group">
              <img
                src={akadaboy}
                alt="banner-img"
                // className='object-cover h-[450px] col-span-2 rounded-xl'

                className="md:rounded-l-2xl lg:rounded-2xl md:h-[395px] lg:h-[32rem] w-full hidden md:block transition group-hover:kenburns-top"
              />
              <img
                src={greenrec}
                alt="banner-img"
            ...
            <div className="w-[12%] relative overflow-hidden lg:block  hidden ">
              <img
                src={akadaboy2}
                alt="banner-img"
